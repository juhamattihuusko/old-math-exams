...
\section*{Uusintakoe touko-kesäkuu 2024}

\subsubsection*{Matematiikan perusteet tietotekniikassa 1, IN00EH18-3001}

\begin{enumerate}
%\setlength{\itemsep}{40pt}
\item Sievennä lauseke
%$$\brac{\frac23+\frac34}\bigg/\brac{6-\frac13}$$\ratkaisu{1/4} %ma
    $$\brac{\frac26+\frac38}\bigg/\brac{3-\frac16}$$\ratkaisu{1/2} %ti
...
$$(4x-1)^2-4(3-2x).$$\ratkaisu{$16x^2-11$} %ti
...
\def\a{5}\def\b{4}\def\c{3}\def\d{2} %uusinta
